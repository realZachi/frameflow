...
Frameflow's source code and project-authored assets are distributed under the repository's [MIT License](LICENSE). Third-party assets remain subject to their original licenses.
...
The following overlays were added by the original Frameflow contributors. Git history does not contain an external source URL or separate license notice, so they are treated as project assets contributed under MIT.
